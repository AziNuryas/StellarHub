...
/* ─────────────────────────────────────────────────────
   SEEDED PSEUDO-RANDOM — no hydration mismatch
───────────────────────────────────────────────────── */
...
// Static twinkling + drifting stars
...
const FEATURES = [
  {
    icon: Camera, title: 'NASA API Integration',
    desc: 'Pull live APOD & Mars Rover imagery directly into your feed. Real data, every single day.',
    accent: '#a78bfa', tag: 'Live Data', glow: 'rgba(167,139,250,0.15)',
  },
  {
    icon: Newspaper, title: 'Create & Share Posts',
    desc: 'Compose posts with image URLs and captions. Share cosmic discoveries with the universe.',
    accent: '#38bdf8', tag: 'Social', glow: 'rgba(56,189,248,0.12)',
  },
  {
    icon: Heart, title: 'Like & Bookmark',
    desc: 'React to posts and build a personal archive of your favourite space moments in time.',
    accent: '#f472b6', tag: 'Engagement', glow: 'rgba(244,114,182,0.12)',
  },
  {
    icon: Radio, title: 'Dynamic Feed System',
    desc: 'Real-time feed powered by Supabase — content stays fresh as the universe expands.',
    accent: '#34d399', tag: 'Real-time', glow: 'rgba(52,211,153,0.12)',
  },
]
...
export default function StellarHubLanding() {
  ...
  useEffect(() => {
    ...
    // Intersection Observer for scroll reveals — no GSAP needed
  ...
  return (
    <div className="sh-root">
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .galaxy {
          position: absolute;
          border-radius: 50%;
          background: radial-gradient(circle, rgba(255,255,255,0.55) 0%, rgba(196,181,253,0.2) 40%, transparent 70%);
          filter: blur(0.8px);
          animation: galaxyPulse var(--gx-dur) ease-in-out var(--gx-delay) infinite;
        }
        @keyframes galaxyPulse {
          0%, 100% { opacity: var(--gx-min); transform: scale(1) rotate(0deg); }
          33%       { opacity: var(--gx-peak); transform: scale(1.3) rotate(3deg); }
          66%       { opacity: calc(var(--gx-min) * 1.5); transform: scale(0.85) rotate(-2deg); }
        }
        ...
        .hero {
          ...
          padding: clamp(80px, 12vw, 120px) 20px clamp(60px, 8vw, 100px);
          text-align: center;
        }
        ...
        .or-1 { inset: 0; border-color: rgba(124,58,237,0.8); animation: spin 25s linear infinite; }
        .or-2 { inset: 65px; border-color: rgba(14,165,233,0.6); animation: spin 18s linear reverse infinite; }
        .or-3 { inset: 130px; border-color: rgba(52,211,153,0.4); animation: spin 12s linear infinite; }
        ...
        .od-1 { left: 0; margin-left: -4px; background: #a78bfa; box-shadow: 0 0 10px #a78bfa; }
        .od-2 { right: 65px; top: 65px; background: #38bdf8; box-shadow: 0 0 8px #38bdf8; }
        .od-3 { left: 50%; bottom: 130px; background: #34d399; box-shadow: 0 0 6px #34d399; }
        ...
        .hero-sub {
          ...
          line-height: 1.8;
          font-weight: 300;
          animation: fadeSlideUp 0.9s cubic-bezier(0.16, 1, 0.3, 1) 0.36s both;
        }
        ...
        .cta-row {
          ...
          animation: fadeSlideUp 0.9s cubic-bezier(0.16, 1, 0.3, 1) 0.50s both;
        }
        .btn-primary {
          display: inline-flex;
          align-items: center;
        ...
        .btn-primary:hover {
          ...
          box-shadow: 0 0 40px rgba(124,58,237,0.5), 0 8px 30px rgba(0,0,0,0.4);
        }
        ...
        .btn-secondary {
          ...
          font-family: 'Syne', sans-serif;
          text-decoration: none;
          transition: transform 0.2s var(--ease-spring), background 0.3s, border-color 0.3s;
        }
        .btn-secondary:hover {
        ...
        .btn-primary:hover .arr-anim,
        .btn-secondary:hover .arr-anim { transform: translateX(4px); }
        ...
        .stat-card:hover {
          ...
          box-shadow: 0 12px 40px rgba(124,58,237,0.12), 0 0 0 1px rgba(167,139,250,0.1);
        }
        .stat-val {
          font-family: 'Syne', sans-serif;
          font-size: 1.7rem;
        ...
        .scroll-line {
          ...
          background: linear-gradient(to bottom, transparent, rgba(124,58,237,0.6), rgba(56,189,248,0.3), transparent);
          animation: scrollLine 2.4s cubic-bezier(0.45, 0, 0.55, 1) 2.2s infinite;
        }
        ...
        .mockup-card {
          border-radius: 24px;
          overflow: hidden;
          box-shadow: 0 0 0 1px rgba(255,255,255,0.06), 0 40px 80px rgba(0,0,0,0.5), 0 0 100px rgba(124,58,237,0.06);
        }
        .mockup-bar {
          padding: 12px 16px;
        ...
        .step-connector {
          ...
          width: 66%;
          height: 1px;
          background: linear-gradient(to right, transparent, rgba(124,58,237,0.3), rgba(14,165,233,0.3), transparent);
        }
        ...
        .step-circle::after {
          ...
          inset: -1px;
          border-radius: 50%;
          background: linear-gradient(135deg, rgba(124,58,237,0.4), rgba(14,165,233,0.4));
          z-index: -1;
          opacity: 0;
          transition: opacity 0.3s;
        }
        ...
        .cta-glow-inner {
          ...
          border-radius: 50%;
          background: radial-gradient(ellipse, rgba(124,58,237,0.18) 0%, rgba(14,165,233,0.08) 40%, transparent 70%);
          filter: blur(60px);
        }
        ...
        /* ── FLOAT ANIMATION for orbit icons ── */
        @keyframes floatY {
        ...
        .mock-sidebar-item:not(.active) { color: rgba(160,165,210,0.55); }
      `}</style>
      ...
      <div className="sh-bg">
        ...
        {mounted && (
          <>
            ...
            {/* Mini galaxy clusters */}
            {GALAXIES.map(g => (
              <span key={`g-${g.id}`} className="galaxy"
                style={{
                  left: `${g.x}%`,
                  top: `${g.y}%`,
                  width: g.size,
      ...
      <section className="sh-section hero" style={{ position: 'relative' }}>
        ...
        <div className="orbit-wrap" style={{ display: 'none' }}>
          <div className="orbit-ring or-1"><div className="orbit-dot od-1" /></div>
          <div className="orbit-ring or-2"><div className="orbit-dot od-2" /></div>
          <div className="orbit-ring or-3" />
        </div>
        ...
        <p className="hero-sub">
          StellarHub bridges space enthusiasts with live NASA data,
          community posts, and a dynamic feed that turns curiosity into discovery.
        </p>
        ...
        <div className="cta-row">
          ...
          <Link href="/explore" className="btn-secondary gl">
            <span className="play-circle">
              <Play style={{ width: 11, height: 11, marginLeft: 1 }} />
            </span>
            Explore Now
        ...
        <div className="scroll-hint">
          ...
          <span style={{ fontSize: 9, color: 'rgba(120,125,160,0.5)', textTransform: 'uppercase', letterSpacing: '0.22em', fontWeight: 700, fontFamily: "'Syne', sans-serif" }}>
            Scroll
          </span>
        </div>
      </section>
        ...
        <div className="sec-inner">
          <div className="sec-text-center reveal">
            <div className="sec-label" style={{ color: '#a78bfa', justifyContent: 'center' }}>
              <span className="sec-line" style={{ background: '#a78bfa' }} />
              Platform Features
              <span className="sec-line" style={{ background: '#a78bfa' }} />
            </div>
            <h2 className="sec-h2">
              <span style={{ display: 'block', color: '#f0f0ff' }}>Everything you need to</span>
              <span className="tg">navigate the stars</span>
            </h2>
          </div>
              ...
              <div key={i} className={`feat-card gl reveal reveal-d${(i % 4) + 1}`}>
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24 }}>
                    ...
                    <span className="feat-tag gl" style={{ color: f.accent }}>
                      {f.tag}
                    </span>
                  </div>
                  <h3 className="feat-h3">{f.title}</h3>
                  <p className="feat-p">{f.desc}</p>
                  <a href="#" className="feat-link" style={{ color: f.accent }}>
                    Learn more
          ...
          <div className="mockup-card gl-deep">
            ...
            <div className="mockup-bar">
              ...
              <div className="mockup-url" style={{ flex: 1, margin: '0 16px' }}>
                ...
                <span>stellarhub.app/feed</span>
              </div>
              <Sparkles style={{ width: 14, height: 14, color: '#a78bfa' }} />
            </div>

            {/* Feed layout */}
            <div style={{ padding: 16, display: 'grid', gridTemplateColumns: 'auto 1fr', gap: 14 }}>
              {/* Sidebar */}
              <div style={{ display: 'none', flexDirection: 'column', gap: 4, minWidth: 160 }} className="mock-sidebar">
                {[
                  { icon: Rocket, label: 'Feed', active: true },
                  { icon: Search, label: 'Explore' },
                  { icon: Camera, label: 'NASA APOD' },
                  { icon: Bookmark, label: 'Saved' },
                ].map((item, i) => (
                  <div key={i} className={`mock-sidebar-item ${item.active ? 'active' : ''}`}>
                    <item.icon style={{ width: 14, height: 14, color: item.active ? '#a78bfa' : undefined }} />
                    {item.label}
                  </div>
                ))}
              </div>
        ...
        <div className="sec-inner">
          <div className="sec-text-center reveal">
            <div className="sec-label" style={{ color: '#38bdf8', justifyContent: 'center' }}>
              <span className="sec-line" style={{ background: '#38bdf8' }} />
              How It Works
              <span className="sec-line" style={{ background: '#38bdf8' }} />
            </div>
            <h2 className="sec-h2">
              <span style={{ display: 'block', color: '#f0f0ff' }}>Three steps to</span>
              <span className="tg">your first orbit</span>
            </h2>
          </div>
          ...
          <div className="nasa-card gl-deep reveal">
            ...
            <div className="nasa-inner">
              ...
              <div className="nasa-orb">
                <div className="nasa-ring-outer" />
                <div className="nasa-ring-inner" />
                <div className="nasa-center">
                  <div className="nasa-icon-box">
                    <Satellite style={{ width: 34, height: 34, color: '#38bdf8' }} />
                  </div>
                </div>
                <span className="nasa-chip gl nc-1">APOD</span>
                <span className="nasa-chip gl nc-2">Mars</span>
              </div>

              {/* Text */}
              <div>
                <span style={{ fontSize: 10, color: '#38bdf8', textTransform: 'uppercase', letterSpacing: '0.2em', fontWeight: 700, fontFamily: "'Syne', sans-serif" }}>
                  Powered by NASA Open APIs
                </span>
                <h3 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 'clamp(1.8rem, 4vw, 3rem)', color: '#f0f0ff', margin: '12px 0 16px', lineHeight: 1.1, letterSpacing: '-0.02em' }}>
                  Real space data,<br />right in your feed.
                </h3>
                <p style={{ color: 'rgba(180,185,220,0.65)', lineHeight: 1.78, fontWeight: 300, fontSize: '0.93rem', marginBottom: 0 }}>
                  Every day, fresh imagery from NASA's Astronomy Picture of the Day and Mars Rover
                  missions flows directly into StellarHub — giving your community real data to explore.
                </p>
      ...
      <section className="sh-section cta-section" style={{ position: 'relative', textAlign: 'center' }}>
        ...
        <div style={{ maxWidth: 680, margin: '0 auto', position: 'relative', zIndex: 1 }} className="reveal">
          <div className="gl" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '8px 20px', borderRadius: 100, marginBottom: 32 }}>
            ...
            <span style={{ fontSize: 10, color: 'rgba(200,210,240,0.7)', letterSpacing: '0.18em', textTransform: 'uppercase', fontWeight: 700, fontFamily: "'Syne', sans-serif" }}>
              Join 150,000+ explorers
            </span>
          </div>
          <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 'clamp(2.5rem, 7vw, 5.5rem)', lineHeight: 0.95, letterSpacing: '-0.025em', marginBottom: 24 }}>
            <span style={{ display: 'block', color: '#f0f0ff' }}>Your journey</span>
            <span className="tg">begins now.</span>
          </h2>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'center', alignItems: 'center' }}>
            <Link
              href={user ? '/dashboard' : '/register'}
              className="btn-primary"
              style={{ padding: '16px 40px', fontSize: '1.05rem', boxShadow: '0 0 60px rgba(124,58,237,0.38), 0 8px 40px rgba(0,0,0,0.4)' }}
            >
              <Zap style={{ width: 18, height: 18 }} />
              {user ? 'Open Dashboard' : 'Launch Into Space'}
              <ArrowRight className="arr-anim" style={{ width: 18, height: 18 }} />
            </Link>
            <span style={{ fontSize: 13, color: 'rgba(120,125,160,0.6)', fontWeight: 500 }}>
        ...
        <div className="footer-inner">
          <Link href="/" className="footer-logo">
            <div className="footer-logo-icon">
              <Rocket style={{ width: 16, height: 16, color: '#fff' }} />
            </div>
            <span className="tg" style={{ fontSize: '1.1rem', fontFamily: "'Syne', sans-serif", fontWeight: 800, letterSpacing: '-0.02em' }}>
              StellarHub
            </span>
          </Link>
          ...
          <p className="footer-copy">
            © {new Date().getFullYear()} StellarHub. Built for stargazers.
          </p>
        </div>
      </footer>
    </div>
